...
const GestorPlanos: React.FC = () => {
  ...
  const modalidadesDisponiveis = ['Musculação', 'Spinning', 'Yoga', 'Pilates', 'CrossFit', 'Funcional', 'Dança', 'Lutas'];
  ...
  return <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 py-[21px]">Planos de Assinatura da Academia: Wefit Centro</h1>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="ativos" className="space-y-4">
              <div className="grid gap-4">
                {planosAtivos.map(plano => <Card key={plano.id} className="relative">
                    <CardHeader>
                      <div className="flex justify-between items-start">
                        <div>
                          <CardTitle className="flex items-center gap-2">
                            {plano.nome}
                            {plano.precoPromocional && <Badge variant="destructive" className="text-xs">
                                PROMOÇÃO
                              </Badge>}
                            {plano.visivel && <Badge variant="default" className="text-xs">
                                VISÍVEL ONLINE
                              </Badge>}
                          </CardTitle>
                        ...
                        <div className="text-right">
                          {plano.precoPromocional ? <div>
                            ...
                            </div> : <p className="text-2xl font-bold">R$ {plano.preco.toFixed(2)}</p>}
            ...
            <TabsContent value="arquivados" className="space-y-4">
              <div className="grid gap-4">
                {planosArquivados.map(plano => <Card key={plano.id} className="opacity-75">
                    <CardHeader>
                      <div className="flex justify-between items-start">
                        <div>
                          <CardTitle className="flex items-center gap-2">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleCriarPlano)} className="space-y-6">
              ...
              field
                    ...
                    <FormControl>
                      <Textarea placeholder="Descreva o que o plano inclui, benefícios, público-alvo..." rows={3} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />

              <div className="grid grid-cols-3 gap-4">
                <FormField control={form.control} name="preco" render={({
                field
              }) => <FormItem>
                ...
                <FormField control={form.control} name="precoPromocional" render={({
                field
              }) => <FormItem>
                ...
                <FormField control={form.control} name="taxaMatricula" render={({
                field
              }) => <FormItem>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {modalidadesDisponiveis.map(modalidade => <div key={modalidade} className="flex items-center space-x-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="limiteSemanal" render={({
                field
              }) => <FormItem>
