  ...
  const plans = [
    {
      ...
      originalPrice: "99",
      features: [
        "Gestão de até 50 alunos",
        "App do Aluno personalizado",
    ...
    },
    {
      ...
      features: [
        ...
        "Painel admin global",
        "Analytics avançado e comparativo",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
            {plans.map((plan, index) => (
              <Card key={index} className={`relative p-8 ${plan.popular ? 'border-2 border-purple-500 shadow-xl' : ''}`}>
                {plan.popular && (
